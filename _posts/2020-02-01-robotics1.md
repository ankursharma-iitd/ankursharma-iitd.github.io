...
{% include image.html url="/images/robotics1/2.png" description="Fig 2: All possible transitions within the state space and the spatial likelihood of observations" %}

## Probabilistic Graphical Model (PGM)

{% include image.html url="/images/robotics1/3.png" description="Fig 3: Bayesian Network showing the causal cause-effect relationships" %}
